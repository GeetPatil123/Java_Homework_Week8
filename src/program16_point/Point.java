...
public class Point {//class
    ...
    public Point(int x, int y) {//constructor with params
        this.x = x;
        this.y = y;
    }
    ...
    public int getX() {//int method
        return x;//returning a value
    }

    public void setX(int x) {//void method
        this.x = x;//setting a value
    }

    public int getY() {//int method
        return y;//returning a vlue
    }

    public void setY(int y) {//void method
        this.y = y;//setting a value
    }
