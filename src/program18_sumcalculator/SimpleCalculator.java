package program18_sumcalculator;
...
public class SimpleCalculator {//class
    ...
    public double getFirstNumber() {//method returning value
        return firstNumber;
    }

    public void setFirstNumber(double firstNumber) {//method setting a value
        this.firstNumber = firstNumber;
    }

    public double getSecondNumber() {//method returning value
        return secondNumber;
    }

    public void setSecondNumber(double secondNumber) {//method setting a value
