 ...
 */
public class Program5_Palindrome {//class
    ...
    public static boolean isPalindrome(int number){//instance method
        ...
        return originalNumber == reverse;//returing the revise number
