...
public class Program7_SumFirstAndLastDigit {//class

    public static void main(String[] args) {//main method
        sumFirstAndLastDigit();//object calling directly as the method is static
    }

    public static  void sumFirstAndLastDigit()//static method
    {

        int number, first_digit, last_digit;
        Scanner sc=new Scanner(System.in);
        System.out.print(" Please Enter any Number that you wish : ");
        number = sc.nextInt();//assigning the values to variables
        first_digit = number;
        ...
        System.out.println("\n First Digit is " + first_digit+ " and Last Digit is " +last_digit+ " which us "  +first_digit+ " + " +last_digit+ " The sum is :" +sum );
