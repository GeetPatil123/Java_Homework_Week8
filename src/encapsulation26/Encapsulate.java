...
public class Encapsulate {
    ...
    //get method for name to access private variable names
    ...
    //set method for roll to access private variabe rollNo
    public void setRollNo(int rollNo){
        this.rollNo=rollNo;
    }

    //get methos for age to access private variable age
    public int getAge(){
        return age;
    }
